 ...
 * @since   1.2
 */
public class HashMapCpy<K,V> extends AbstractMap<K,V>
     ...
     */
    public HashMapCpy(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public HashMapCpy(int initialCapacity) {
     ...
     */
    public HashMapCpy(Map<? extends K, ? extends V> m) {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final void clear()               { HashMapCpy.this.clear(); }
        ...
        public final Spliterator<K> spliterator() {
            return new KeySpliterator<>(HashMapCpy.this, 0, -1, 0, 0);
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public final Spliterator<V> spliterator() {
            return new ValueSpliterator<>(HashMapCpy.this, 0, -1, 0, 0);
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public final Spliterator<Map.Entry<K,V>> spliterator() {
            return new EntrySpliterator<>(HashMapCpy.this, 0, -1, 0, 0);
        }
    ...
    @Override
    public Object clone() {
        HashMapCpy<K,V> result;
        try {
            result = (HashMapCpy<K,V>)super.clone();
...
//    }
    ...
    static class HashMapSpliterator<K,V> {
        ...
        HashMapSpliterator(HashMapCpy<K,V> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<K,V>
        ...
        KeySpliterator(HashMapCpy<K,V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(HashMapCpy<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(HashMapCpy<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class TreeNode<K,V> extends LinkedHashMapCpy.Entry<K,V> {
         ...
         * this node.
         */
        final Node<K,V> untreeify(HashMapCpy<K,V> map) {
         ...
         */
        final TreeNode<K,V> putTreeVal(HashMapCpy<K,V> map, Node<K,V>[] tab,
                                       int h, K k, V v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(HashMapCpy<K,V> map, Node<K,V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(HashMapCpy<K,V> map, Node<K,V>[] tab, int index, int bit) {
            TreeNode<K,V> b = this;
     ...
     * @since 19
     */
    public static <K, V> HashMapCpy<K, V> newHashMap(int numMappings) {
        if (numMappings < 0) {
            throw new IllegalArgumentException("Negative number of mappings: " + numMappings);
        }
        return new HashMapCpy<>(calculateHashMapCpyCapacity(numMappings));
    }
    ...
    private long heapSize() {
        ...
        for (Node<K,V> te : tab) {
            if (te != null) { // TODO changed but not verified
                for (Node<K, V> e = te.next; e != null; e = e.next) // TODO doesn't handle TreeNodes
