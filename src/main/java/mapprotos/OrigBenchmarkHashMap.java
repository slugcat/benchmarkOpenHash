...
/**
 * OrigBenchmarkHashMap using hashing and "open addressing".
 ...
 * {@code null} values and the {@code null} key.  (The {@code OrigBenchmarkHashMap}
 ...
 * {@code OrigBenchmarkHashMap} instance (the number of buckets) plus its size (the number
 * of key-value mappings).  Thus, it's very important not to set the initial
 * capacity too high (or the load factor too low) if iteration performance is
 * important.
 *
 * <p>An instance of {@code OrigBenchmarkHashMap} has two parameters that affect its
 ...
 * the operations of the {@code OrigBenchmarkHashMap} class, including
 ...
 *
 * <p>If many mappings are to be stored in a {@code OrigBenchmarkHashMap}
 ...
 *   Map m = Collections.synchronizedMap(new OrigBenchmarkHashMap(...));</pre>
 *
 ...
 * @since   1.2
 */
public class OrigBenchmarkHashMap/*was OrigBenchmarkHashMap*/<K,V> extends XAbstractMap<K,V>
    ...
    /**
     * The number of times this OrigBenchmarkHashMap has been structurally modified
     * Structural modifications are those that change the number of mappings in
     * the OrigBenchmarkHashMap or otherwise modify its internal structure (e.g.,
     * rehash).  This field is used to make iterators on Collection-views of
     * the OrigBenchmarkHashMap fail-fast.  (See ConcurrentModificationException).
     */
    ...
    /**
     * Constructs an empty {@code OrigBenchmarkHashMap} with the specified initial
     ...
     */
    public OrigBenchmarkHashMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public OrigBenchmarkHashMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR);
    }

    /**
     * Constructs an empty {@code OrigBenchmarkHashMap} with the default initial capacity
     * (16) and the default load factor (0.75).
     */
    public OrigBenchmarkHashMap() {
        this.loadFactor = DEFAULT_LOAD_FACTOR; // all other fields defaulted
    }

    /**
     * Constructs a new {@code OrigBenchmarkHashMap} with the same mappings as the
     * specified {@code Map}.  The {@code OrigBenchmarkHashMap} is created with
     ...
     */
    public OrigBenchmarkHashMap(Map<? extends K, ? extends V> m) {
...
//                putProbes = incProbeCount(putProbes, probes);
   ...
   private void debug2(String msg, int index, YNode<K,V> entry) {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final void clear()               { OrigBenchmarkHashMap.this.clear(); }
...
//                    modCount++;
    ...
    /**
     * Returns a shallow copy of this {@code OrigBenchmarkHashMap} instance: the keys and
    ...
    @Override
    public Object clone() {
        OrigBenchmarkHashMap<K,V> result;
        try {
            result = (OrigBenchmarkHashMap<K,V>)super.clone();
     ...
     * @serialData The <i>capacity</i> of the OrigBenchmarkHashMap (the length of the
...
//            SharedSecrets.getJavaObjectInputStreamAccess().checkArray(s, Map.Entry[].class, cap);
            ...
            // Read the keys and values, and put the mappings in the OrigBenchmarkHashMap
