...
public class ArrayOfArraysOfPrimitive implements ArrayOfNodeLists {

    static /* TODO primitive*/     class Node {
        final int intKey;
        final Object objKey;
        final Object value;
    ...
    public ArrayOfArraysOfPrimitive(int tableLen, int binLen) {
    ...
    public Object get(int intTableIndex, int intKey, Object objKey) {
        ...
        ArrayOfArraysOfPrimitive.Node[] nodes = (ArrayOfArraysOfPrimitive.Node[]) table[intTableIndex];
        for (final ArrayOfArraysOfPrimitive.Node node : nodes) {
            Object k;
